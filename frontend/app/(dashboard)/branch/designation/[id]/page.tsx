...
import { getEmployeeById } from "@/services/branch.service";
            ...
            {employee && (                
                <div style={{
                        ...
                        <div>
                            <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                                ...
                                <span style={{
                                    ...
                                    {employee.status == true ? 'Active' : 'Deactive'}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        <InfoItem icon="ti-user" label="Owner" value={`${employee.firstName} ${employee.lastName}`} />
                        <InfoItem icon="ti-phone" label="Phone" value={employee.phone} mono />
                        {employee.address && <InfoItem icon="ti-map-pin" label="Address" value={employee.address} />}
                    </div>
                </div>
            )}
