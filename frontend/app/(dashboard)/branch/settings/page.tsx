...
import { getBranchSettings, updateBranchSettings } from "@/services/branchSettings.service";
...
export default function BranchSettingsPage() {
    ...
    async function fetchSettings() {
        try {
            ...
            toast.error(message || "Failed to load branch settings");
        } finally {
            setLoading(false);
        }
    }
    ...
    const handleSave = async () => {
        try {
            ...
            toast.error(message || "Failed to save branch settings");
        } finally {
            setSaving(false);
        }
    };
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Manage this branch&apos;s profile, preferences and location
                    </p>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-5 lg:col-span-2">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-base font-bold text-slate-900">Branch Timing</h2>
                                <p className="text-xs text-slate-500">
                                    set the working hours and recess timing of the branch
                                </p>
                            </div>
                        </div>
                        <div
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-5 lg:col-span-2">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-base font-bold text-slate-900">Branch Location</h2>
                                <p className="text-xs text-slate-500">
                                    Capture the exact GPS coordinates of this branch
                                </p>
                            </div>
                        </div>
