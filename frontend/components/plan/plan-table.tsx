...
export default function Table({ plans, onCreate, onDelete, onEdit }: Props) {
  ...
  const filtered = useMemo(() => {
    ...
    return plans.filter(r => r.name?.toLowerCase().includes(q));
  }, [plans, search]);
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
            <thead>
              <tr>
                ...
                >
                  Plan Name <SortIcon active dir={sortDir} />
                </th>

                <th style={thStyle()}>Type</th>
                <th style={thStyle()}>Monthly Price</th>
                <th style={thStyle()}>Annual Price</th>
              ...
              {paginated.length === 0 ? (
                <tr>
                  <td colSpan={4} style={{ padding: "60px 24px", textAlign: "center", color: "#94a3b8" }}>
                    ...
                    <p style={{ fontWeight: 600, color: "#64748b", margin: "0 0 4px" }}>No plans found</p>
                ...
                const isSystem = role.isCustom === true || (role.isCustom as any) === "true";
                      ...
                      <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>  
                        ...
                        <Can permission="plan.delete">
                          <Button
                            type="danger"
                            title="Delete"
                            icon={<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
