...
export default function RoleTable({ roles, onCreate, onDelete, onView }: Props) {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
            <thead>
              <tr>
                ...
                >
                  Role Name <SortIcon active dir={sortDir} />
                </th>
              ...
              {paginated.length === 0 ? (
                <tr>
                  <td colSpan={4} style={{ padding: "60px 24px", textAlign: "center", color: "#94a3b8" }}>
                    ...
                    <p style={{ fontWeight: 600, color: "#64748b", margin: "0 0 4px" }}>No roles found</p>
