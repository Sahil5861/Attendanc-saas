...
type SortKey = "companyName" | "ownerName" | "email";
...
export default function CompanyTable({ companies, onCreate, onEdit, onView, onDelete }: Props) {
      ...
      <div style={{
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
            <thead>
              <tr>
                <th style={thStyle("companyName")} onClick={() => handleSort("companyName")}>
                  Company <SortIcon active={sortKey === "companyName"} dir={sortDir} />
                </th>
                <th style={thStyle("ownerName")} onClick={() => handleSort("ownerName")}>
                  Owner <SortIcon active={sortKey === "ownerName"} dir={sortDir} />
                </th>
              ...
              {paginated.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "16px 18px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div>
                          ...
                          <p style={{ fontSize: 11, color: "#94a3b8", margin: "2px 0 0", letterSpacing: "0.05em" }}>
                            {company.companyCode}
                          </p>
                        </div>
                      </div>
                    ...
                    {/* Email */}
                    <td style={{ padding: "16px 18px" }}>
                      <a href={`mailto:${company.email}`} style={{ color: "#0891b2", textDecoration: "none", fontSize: 13 }}>
                        {company.email}
                      </a>
                    </td>
